...
it('should display number of available seats correctly', async () => {
...
it("should display 'sold out' message and NO purchase button if there are no seats available", async () => {
